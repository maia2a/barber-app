      ...
      <Card className="min-w-[90%]">
        <CardContent className="flex justify-between p-0">
          <div className="flex flex-col gap-2 py-5 pl-5">
            <Badge className="w-fit" variant={isConfirmed ? "default" : "destructive"}>{isConfirmed ? "Confirmada" : "Finalizada"}</Badge>
            ...
            <div className="flex items-center gap-2">
              ...
              <p className="text-sm font-semibold">{booking.service.barbershop.name}</p>
            </div>
          </div>
